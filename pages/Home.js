...
import wallpaper from "../assets/wallpaper-car.jpg";
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={styles.container}>
        <Text style={styles.text}>CONHEÇA OS CARROS BRASILEIROS</Text>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            navigation.navigate("Modelos", {
              idMarca: selectedValue.itemValue,
              nomeMarca: register[selectedValue.itemIndex || 0].nome
            });
          }}
        >
